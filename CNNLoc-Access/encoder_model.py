...
#################AE_model
    def fnBuildAEModel(self):
        ...
        decode_layer = Dense(301, activation='elu', name='de-1')(decode_layer)
...
###################Building_model
    def fnBuildBuildingModel(self):
        ...
        if Train_Building or Run_Building:
            ...
            self.buildingID_predict_output=Dense(1,activation='softmax')(building_net)
